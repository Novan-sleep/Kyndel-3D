...
export default function StatistikPage() {
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:20 }}>
      ...
      {/* ── KPI Cards ─────────────────────────────────────────────────── */}
      <div className="animate-fade-up rgrid-4" style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:16 }}>
      ...
      <div className="animate-fade-up-1 rgrid-main-side" style={{ display:'grid', gridTemplateColumns:'3fr 2fr', gap:16 }}>
      ...
      <div className="animate-fade-up-2 rgrid-wide-3" style={{ display:'grid', gridTemplateColumns:'2fr 1fr 1fr', gap:16 }}>
